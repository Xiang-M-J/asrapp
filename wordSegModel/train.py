...
add_arg('train_data_path', str, 'dataset/pku_training.utf8', '训练数据的数据文件路径')
add_arg('dev_data_path', str, 'dataset/pku_test.utf8', '测试数据的数据文件路径')
...
add_arg('pretrained_token', str, r'D:\work\asrapp\wordSegModel\ernie-3.0-nano-zh',
...
def train():
    ...
    # num_classes为字符分类大小
    model = ErnieLinear(pretrained_token=args.pretrained_token, num_classes=2)
